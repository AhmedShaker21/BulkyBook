...
namespace BulkyBookWeb.Areas.Admin.Controllers {
	...
	public class OrderController : Controller {
        ...
        public OrderController(IUnitOfWork unitOfWork , IConfiguration config)
        {
        ...
        public async Task<IActionResult> Details_PAY_NOW()
        {
            ...
            var flutterwaveRequest = new
            {
                ...
                currency = "NGN",
                redirect_url = domain + $"admin/order/PaymentConfirmation?orderHeaderId={OrderVM.OrderHeader.Id}",
                customer = new
                {
                    email = OrderVM.OrderHeader.ApplicationUser.Email,
                    name = OrderVM.OrderHeader.ApplicationUser.Name
                },
                customizations = new
                {
                    title = "BulkyBook - Admin Payment",
            ...
            TempData["Error"] = "Payment initialization failed.";
            return RedirectToAction(nameof(Details), new { orderId = OrderVM.OrderHeader.Id });
        }
