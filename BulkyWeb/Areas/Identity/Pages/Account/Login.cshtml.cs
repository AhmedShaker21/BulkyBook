    ...
    public class LoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (result.Succeeded)
            {
                ...
                if (await _userManager.IsInRoleAsync(user, "Chairman"))
                    return LocalRedirect("/Customer/Dashboard");

                if (await _userManager.IsInRoleAsync(user, "SectorManager"))
                    return LocalRedirect("/Customer/Dashboard");

                if (await _userManager.IsInRoleAsync(user, "GeneralManager"))
                    return LocalRedirect("/Customer/Dashboard");
